...
- (void)testScanner {
    NSString *input = [NSString stringWithContentsOfFile:[[NSBundle bundleForClass:[self class]] pathForResource:@"test" ofType:@"cm"] encoding:NSASCIIStringEncoding error:nil];
